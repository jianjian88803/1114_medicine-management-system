    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yaopin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="药品功效" prop="yaopinGongxiao">
                        <el-input v-model="yaopinForm.yaopinGongxiao"
                                  placeholder="药品功效" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yaopin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="所治疾病" prop="yaopinJibing">
                        <el-input v-model="yaopinForm.yaopinJibing"
                                  placeholder="所治疾病" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="24" v-if="sessionTable !='yaopin' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yaopinPhoto" label="药品照片" prop="yaopinPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (yaopinForm.yaopinPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='yaopin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="售价" prop="yaopinXiaoshouMoney">
                        <el-input v-model="yaopinForm.yaopinXiaoshouMoney"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="进货编号" prop="jinhuoUuidNumber">
                       <el-input v-model="ruleForm.jinhuoUuidNumber"
                                 placeholder="进货编号" clearable  :readonly="ro.jinhuoUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="进货编号" prop="jinhuoUuidNumber">
                           <el-input v-model="ruleForm.jinhuoUuidNumber"
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="进货数量" prop="jinhuoShuliangNumber">
                       <el-input v-model="ruleForm.jinhuoShuliangNumber"
                                 placeholder="进货数量" clearable  :readonly="ro.jinhuoShuliangNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="进货数量" prop="jinhuoShuliangNumber">
                           <el-input v-model="ruleForm.jinhuoShuliangNumber"
                                     placeholder="进货数量" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="jinhuoContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.jinhuoContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jinhuoContent" label="备注" prop="jinhuoContent">
                            <span v-html="ruleForm.jinhuoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="进货时间" prop="jinhuoTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.jinhuoTime"
                                type="datetime"
                                placeholder="进货时间"
                                :disabled="ro.jinhuoTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.jinhuoTime" label="进货时间" prop="jinhuoTime">
                            <span v-html="ruleForm.jinhuoTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
    ...
    export default {
        data() {
            return {
                ...
                yuangongForm: {},
                ro:{
                    jinhuoUuidNumber: false,
                    yaopinId: false,
                    yuangongId: false,
                    jinhuoShuliangNumber: false,
                    jinhuoContent: false,
                    jinhuoTime: false,
                    insertTime: false,
                },
                ruleForm: {
                    jinhuoUuidNumber: new Date().getTime(),
                    yaopinId: '',
                    yuangongId: '',
                    jinhuoShuliangNumber: '',
                    jinhuoContent: '',
                    jinhuoTime: '',
                    insertTime: '',
                },
                ...
                rules: {
                   jinhuoUuidNumber: [
                              { required: true, message: '进货编号不能为空', trigger: 'blur' },
                          ],
                   yaopinId: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`jinhuo/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.jinhuoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
