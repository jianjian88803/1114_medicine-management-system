    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yuangongId" name="yuangongId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="销售数量" prop="xiaoshouShuliangNumber">
                       <el-input v-model="ruleForm.xiaoshouShuliangNumber"
                                 placeholder="销售数量" clearable  :readonly="ro.xiaoshouShuliangNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="销售数量" prop="xiaoshouShuliangNumber">
                           <el-input v-model="ruleForm.xiaoshouShuliangNumber"
